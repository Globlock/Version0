...
sysroot_directory="http://localhost/API/"
...
update_asset_revision="UPDATE gb_assets SET asset_revision=asset_revision+1 WHERE asset_object = ?"
...
select_all_globe_ids="SELECT globe_id, globe_name FROM gb_globes"
