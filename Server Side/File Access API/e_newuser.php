<?php
	...
	/** */
	validateUser($name, $pass, $last,  $first,  $email,  $dept, $group,  $super, $includegroup, $validuser);
	
	/** */
	function validateUser(&$name, &$pass, &$last, &$first, &$email, &$dept, &$group, &$super, &$includegroup, &$validuser) {
